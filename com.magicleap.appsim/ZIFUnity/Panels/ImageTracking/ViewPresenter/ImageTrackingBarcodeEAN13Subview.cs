...
{
    internal class ImageTrackingBarcodeEAN13Subview : ImageTrackingSubView
    {
        private const string SubviewPath = "Packages/com.magicleap.appsim/ZIFUnity/Panels/ImageTracking/Views/ImageTargetBarcodeEAN13Template.uxml";
        ...
        public ImageTrackingBarcodeEAN13Subview(ImageTargetBuilderWrapper bondedObject) : base(bondedObject)
        {
        }
